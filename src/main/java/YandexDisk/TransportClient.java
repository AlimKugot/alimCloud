...
import YandexDisk.exceptions.CancelledDownloadException;
import YandexDisk.exceptions.CancelledPropfindException;
import YandexDisk.exceptions.DuplicateFolderException;
import YandexDisk.exceptions.FileDownloadException;
import YandexDisk.exceptions.FileTooBigServerException;
import YandexDisk.exceptions.FilesLimitExceededServerException;
import YandexDisk.exceptions.IntermediateFolderNotExistException;
import YandexDisk.exceptions.PreconditionFailedException;
import YandexDisk.exceptions.RangeNotSatisfiableException;
import YandexDisk.exceptions.ServerWebdavException;
import YandexDisk.exceptions.UnknownServerWebdavException;
import YandexDisk.exceptions.UnsupportedMediaTypeException;
import YandexDisk.exceptions.WebdavClientInitException;
import YandexDisk.exceptions.WebdavException;
import YandexDisk.exceptions.WebdavFileNotFoundException;
import YandexDisk.exceptions.WebdavForbiddenException;
import YandexDisk.exceptions.WebdavInvalidUserException;
import YandexDisk.exceptions.WebdavNotAuthorizedException;
import YandexDisk.exceptions.WebdavUserNotInitialized;
import YandexDisk.exceptions.WebdavSharingForbiddenException;
